...
int super_planner::math_utils::RootFinderPriv::polyMod(double *u, double *v, double *r, int lu, int lv) {
    int orderu = lu - 1;
    int orderv = lv - 1;
...
double super_planner::math_utils::RootFinderPriv::polyEval(double *p, int len, double x) {
    double retVal = 0.0;
...
std::set<double> super_planner::math_utils::RootFinderPriv::solveCub(double a, double b, double c, double d) {
...
int super_planner::math_utils::RootFinderPriv::solveResolvent(double *x, double a, double b, double c) {
    double a2 = a * a;
...
std::set<double> super_planner::math_utils::RootFinderPriv::solveQuartMonic(double a, double b, double c, double d) {
    std::set<double> roots;
...
std::set<double> super_planner::math_utils::RootFinderPriv::solveQuart(double a, double b, double c, double d, double e) {
    if (fabs(a) < DBL_EPSILON) {
...
std::set<double>
super_planner::math_utils::RootFinderPriv::eigenSolveRealRoots(const Eigen::VectorXd &coeffs, double lbound, double ubound,
                                                double tol) {
    std::set<double> rts;
...
double super_planner::math_utils::RootFinderPriv::numSignVar(double x, double **sturmSeqs, int *szSeq, int len) {
    double y, lasty;
    int signVar = 0;
...
void super_planner::math_utils::RootFinderPriv::polyDeri(double *coeffs, double *dcoeffs, int len) {
    int horder = len - 1;
...
double super_planner::math_utils::RootFinderPriv::safeNewton(const F &func, const DF &dfunc, const double &l, const double &h,
...
double
super_planner::math_utils::RootFinderPriv::shrinkInterval(double *coeffs, int numCoeffs, double lbound, double ubound, double tol) {
...
void super_planner::math_utils::RootFinderPriv::recurIsolate(double l, double r, double fl, double fr, int lnv, int rnv, double tol,
...
std::set<double>
super_planner::math_utils::RootFinderPriv::isolateRealRoots(const Eigen::VectorXd &coeffs, double lbound, double ubound, double tol) {
    std::set<double> rts;
...
Eigen::VectorXd super_planner::math_utils::RootFinder::polySqr(const Eigen::VectorXd &coef)       {
...
double super_planner::math_utils::RootFinder::polyVal(const Eigen::VectorXd &coeffs, double x, bool numericalStability)   {
    double retVal = 0.0;
    int order = (int) coeffs.size() - 1;
...
int super_planner::math_utils::RootFinder::countRoots(const Eigen::VectorXd &coeffs, double l, double r)         {
    int nRoots = 0;
...
std::set<double>
super_planner::math_utils::RootFinder::solvePolynomial(const Eigen::VectorXd &coeffs, double lbound, double ubound, double tol,
                                        bool isolation)    {
    std::set<double> rts;
