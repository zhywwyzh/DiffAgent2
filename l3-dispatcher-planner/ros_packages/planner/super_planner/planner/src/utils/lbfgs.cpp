...
const char *super_planner::math_utils::lbfgs::lbfgs_strerror(const int err) {
    switch (err) {
...
int super_planner::math_utils::lbfgs::lbfgs_optimize(Eigen::VectorXd &x, double &f,
...
int super_planner::math_utils::lbfgs::line_search_lewisoverton(Eigen::VectorXd &x, double &f, Eigen::VectorXd &g, double &stp,
