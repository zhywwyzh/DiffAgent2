...
public:
  ...
  SlidingMap(const Vec3i& half_map_size_i, const double& resolution, const bool& map_sliding_en,
  ...
  void initSlidingMap(const Vec3i& half_map_size_i, const double& resolution, const bool& map_sliding_en,
                      const double& sliding_thresh, const Vec3f& fix_map_origin);
...
protected:
  ...
  void updateLocalMapOriginAndBound(const Vec3f& new_origin_d, const Vec3i& new_origin_i);
