...
namespace rog_map {
using super_planner::super_utils::Vec3f;
using super_planner::super_utils::Vec3i;
using super_planner::super_utils::vec_E;
using super_planner::super_utils::vec_Vec3f;
...
template <typename Scalar_t> static Scalar_t get_yaw_from_quaternion(const Eigen::Quaternion<Scalar_t>& q) {
  return quaternion_to_ypr(q)(0);
}

static double computePathLength(const super_planner::super_utils::vec_E<super_planner::super_utils::Vec3f>& path) {
  if (path.size() < 2) {
    return 0.0;
  }
  double len = 0.0;
...
static super_planner::super_utils::Vec3f lineBoxIntersectPoint(const super_planner::super_utils::Vec3f& pt,
                                                               const super_planner::super_utils::Vec3f& pos,
                                                               const super_planner::super_utils::Vec3f& box_min,
                                                               const super_planner::super_utils::Vec3f& box_max) {
...
static bool GetIntersection(float fDst1, float fDst2, super_planner::super_utils::Vec3f P1,
                            super_planner::super_utils::Vec3f P2, super_planner::super_utils::Vec3f& Hit) {
  if ((fDst1 * fDst2) >= 0.0f)
    return false;
  if (fDst1 == fDst2)
    return false;
...
static bool InBox(super_planner::super_utils::Vec3f Hit, super_planner::super_utils::Vec3f B1,
                  super_planner::super_utils::Vec3f B2, const int Axis) {
...
static bool lineIntersectBox(super_planner::super_utils::Vec3f L1, super_planner::super_utils::Vec3f L2,
                             super_planner::super_utils::Vec3f B1, super_planner::super_utils::Vec3f B2,
                             super_planner::super_utils::Vec3f& Hit) {
