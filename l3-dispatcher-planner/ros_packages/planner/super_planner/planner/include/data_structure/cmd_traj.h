...
namespace super_planner {
    using super_planner::geometry_utils::Trajectory;
    ...
    public:
        ...
        bool setTrajectory(const ExpTraj&exp_traj,
            ...
            if (!exp_traj.getPartialTrajectoryByTrajectoryTime(0, backup_traj_start_TT_,
                ...
                SLOG_WARN(" -- [SUPER] in [PlanFromRest] getPartialTrajectoryByTime failed.");
                return false;
            }
        ...
        void setStartWallTime(const double &t) {
            pos_traj_.start_WT = t;
            yaw_traj_.start_WT = t;
            start_WT_ = t;
        }
